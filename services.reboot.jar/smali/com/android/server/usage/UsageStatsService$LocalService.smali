...
.method public reportEvent(Landroid/content/ComponentName;Landroid/content/Intent;II)V
    ...
    const-string/jumbo v9, "Event reported without a component name"
    ...
    iput-object v8, v5, Landroid/app/usage/UsageEvents$Event;->mPackage:Ljava/lang/String;

    invoke-virtual {p1}, Landroid/content/ComponentName;->getClassName()Ljava/lang/String;

    move-result-object v8

    iput-object v8, v5, Landroid/app/usage/UsageEvents$Event;->mClass:Ljava/lang/String;

    invoke-static {}, Landroid/os/SystemClock;->elapsedRealtime()J

    move-result-wide v8

    iput-wide v8, v5, Landroid/app/usage/UsageEvents$Event;->mTimeStamp:J

    iput p4, v5, Landroid/app/usage/UsageEvents$Event;->mEventType:I
    ...
    invoke-virtual {v8, v10, p3, v10, v5}, Landroid/os/Handler;->obtainMessage(IIILjava/lang/Object;)Landroid/os/Message;
    ...
    invoke-static {v8}, Lcom/android/server/usage/UsageStatsService;->-get2(Lcom/android/server/usage/UsageStatsService;)Ljava/util/HashMap;
