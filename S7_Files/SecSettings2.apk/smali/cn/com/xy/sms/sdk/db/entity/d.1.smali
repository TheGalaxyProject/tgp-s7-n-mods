...
# static fields
.field private static a:Ljava/lang/String; = "tb_emergency_queue"
...
.method public static a(Lorg/json/JSONArray;)V
    ...
    :try_start_1
    const-string/jumbo v0, "emContent"
    ...
    const-string/jumbo v2, "emVersion"

    invoke-static {v1, v2}, Lcn/com/xy/sms/sdk/util/JsonUtil;->getValueFromJsonObject(Lorg/json/JSONObject;Ljava/lang/String;)Ljava/lang/Object;
    ...
    const-string/jumbo v3, "insertOrUpdateEmergency "
    ...
    const-string/jumbo v2, "tb_emergency_queue"
    ...
    const-string/jumbo v7, "emVersion"

    aput-object v7, v5, v6

    const-string/jumbo v6, "emVersion = ?"
    ...
    invoke-static {v2, v5, v6, v7}, Lcn/com/xy/sms/sdk/db/DBManager;->query(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;)Lcn/com/xy/sms/sdk/db/XyCursor;
    :try_end_3
    ...
    const-string/jumbo v6, "emContent"
    ...
    :cond_5
    const-string/jumbo v0, "tb_emergency_queue"
    ...
    invoke-static {v0, v5, v6, v7}, Lcn/com/xy/sms/sdk/db/DBManager;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_6
    ...
    const-string/jumbo v6, "insertOrUpdateEmergency "
...
.method public static a(Lorg/json/JSONObject;)V
    ...
    :try_start_0
    const-string/jumbo v0, "emVersion"
    ...
    :goto_0
    const-string/jumbo v1, "tb_emergency_queue"
...
.method public static b()Lorg/json/JSONObject;
    ...
    const-string/jumbo v2, "emContent"

    aput-object v2, v1, v0

    const-string/jumbo v0, "tb_emergency_queue"

    const-string/jumbo v6, " emVersion asc"
    ...
    const-string/jumbo v4, "queryNextEmergency: "
...
.method private static b(Lorg/json/JSONObject;)V
    ...
    const-string/jumbo v1, "emVersion"
    ...
    const-string/jumbo v3, "tb_emergency_queue"
    ...
    const-string/jumbo v5, "emVersion = ?"
    ...
    const-string/jumbo v4, "emVersion"

    invoke-virtual {v3, v4, v1}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v4, "emContent"
    ...
    invoke-static {v0, v3}, Lcn/com/xy/sms/sdk/db/DBManager;->insert(Ljava/lang/String;Landroid/content/ContentValues;)J
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_0
    ...
    invoke-static {v0, v3, v4, v5}, Lcn/com/xy/sms/sdk/db/DBManager;->update(Ljava/lang/String;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    :try_end_3
    ...
    const-string/jumbo v4, "insertOrUpdateEmergency "
