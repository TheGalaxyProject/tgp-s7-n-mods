...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Bundle;)V
    ...
    iput-object v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->mScanResultCache:Landroid/util/LruCache;

    .line 153
    const/4 v4, -0x1

    iput v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->networkId:I
    ...
    iput-boolean v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->mIsDcm:Z
    ...
    .line 200
    :try_start_0
    const-string/jumbo v4, "key_config"
    ...
    iput-object v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->mConfig:Landroid/net/wifi/WifiConfiguration;
    ...
    invoke-virtual {p0, v4}, Lcom/android/settingslib/wifi/AccessPoint;->loadConfig(Landroid/net/wifi/WifiConfiguration;)V
    :try_end_0
    ...
    :cond_0
    :goto_0
    const-string/jumbo v4, "key_ssid"
    ...
    iput-object v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->ssid:Ljava/lang/String;

    .line 210
    :cond_1
    const-string/jumbo v4, "key_security"
    ...
    iput v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->security:I

    .line 213
    :cond_2
    const-string/jumbo v4, "key_psktype"
    ...
    .line 216
    :cond_3
    const-string/jumbo v4, "key_wifiinfo"
    ...
    .line 217
    const-string/jumbo v4, "key_networkinfo"
    ...
    .line 220
    :cond_4
    const-string/jumbo v4, "key_scanresultcache"
    ...
    .line 223
    .local v3, "scanResultArrayList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/net/wifi/ScanResult;>;"
    ...
    .end local v2    # "result$iterator":Ljava/util/Iterator;
    .end local v3    # "scanResultArrayList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/net/wifi/ScanResult;>;"
    :catch_0
    move-exception v0
    ...
    const-string/jumbo v5, "can\'t load Wi-Fi configuration"
    ...
    :cond_5
    const-string/jumbo v4, "key_keymgmts"
    ...
    iput-object v4, p0, Lcom/android/settingslib/wifi/AccessPoint;->keyMgmts:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Lcom/android/settingslib/wifi/AccessPoint;->mNetworkInfo:Landroid/net/NetworkInfo;

    invoke-virtual {p0, v4, v5, v6}, Lcom/android/settingslib/wifi/AccessPoint;->update(Landroid/net/wifi/WifiConfiguration;Landroid/net/wifi/WifiInfo;Landroid/net/NetworkInfo;)Z
