...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 103
    .end local v9    # "configChanges":I
    .end local v134    # "show":Z
    :cond_3
    const/16 v134, 0x0

    .restart local v134    # "show":Z
    goto :goto_3
    ...
    .line 134
    .local v130, "resumeArgs":Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .end local v130    # "resumeArgs":Landroid/os/Bundle;
    :cond_6
    const/16 v27, 0x0
    ...
    .line 247
    .end local v47    # "processState":I
    .end local v126    # "rebind":Z
    :cond_10
    const/16 v126, 0x0

    .restart local v126    # "rebind":Z
    goto :goto_e
    ...
    .line 389
    .local v125, "proxyInfo":Landroid/net/ProxyInfo;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I
    ...
    .end local v125    # "proxyInfo":Landroid/net/ProxyInfo;
    ...
    .line 407
    .local v131, "service":Landroid/os/IBinder;
    ...
    .end local v131    # "service":Landroid/os/IBinder;
    :sswitch_1b
    const-string/jumbo v5, "android.app.IApplicationThread"
    ...
    .line 422
    .restart local v131    # "service":Landroid/os/IBinder;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readStringArray()[Ljava/lang/String;
    ...
    .line 465
    .end local v127    # "reportToActivity":Z
    :cond_1f
    const/16 v127, 0x0
    ...
    .end local v136    # "start":Z
    :cond_20
    const/16 v136, 0x0

    .restart local v136    # "start":Z
    goto :goto_1c
    ...
    .line 531
    .local v116, "msg":Ljava/lang/String;
    move-object/from16 v0, p0
    ...
    .line 537
    .end local v116    # "msg":Ljava/lang/String;
    :sswitch_26
    const-string/jumbo v5, "android.app.IApplicationThread"
    ...
    .line 538
    .end local v107    # "fd":Landroid/os/ParcelFileDescriptor;
    .end local v115    # "managed":Z
    .end local v119    # "path":Ljava/lang/String;
    :cond_22
    const/16 v115, 0x0

    .restart local v115    # "managed":Z
    goto :goto_1e
    ...
    .line 565
    .local v133, "settings":Landroid/os/Bundle;
    move-object/from16 v0, p0
    ...
    .line 570
    .end local v133    # "settings":Landroid/os/Bundle;
    :sswitch_29
    const-string/jumbo v5, "android.app.IApplicationThread"
    ...
    .line 655
    .local v124, "provider":Landroid/os/IBinder;
    move-object/from16 v0, p0
    ...
    .line 662
    .end local v124    # "provider":Landroid/os/IBinder;
    :sswitch_2f
    const-string/jumbo v5, "android.app.IApplicationThread"
    ...
    .line 665
    .local v128, "requestToken":Landroid/os/IBinder;
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I

    move-result v129

    .line 666
    .local v129, "requestType":I
    invoke-virtual/range {p2 .. p2}, Landroid/os/Parcel;->readInt()I

    move-result v132

    .line 667
    .local v132, "sessionId":I
    move-object/from16 v0, p0
    ...
    .end local v128    # "requestToken":Landroid/os/IBinder;
    .end local v129    # "requestType":I
    .end local v132    # "sessionId":I
    :sswitch_30
    const-string/jumbo v5, "android.app.IApplicationThread"
    ...
    .line 840
    .restart local v133    # "settings":Landroid/os/Bundle;
    move-object/from16 v0, p0
