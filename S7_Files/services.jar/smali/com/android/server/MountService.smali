...
.method private isMountDisallowed(Landroid/os/storage/VolumeInfo;)Z
    ...
    .line 1676
    .local v2, "encrypt_state":Ljava/lang/String;
    const-string/jumbo v0, "null"

    .line 1677
    .local v0, "crypto_type":Ljava/lang/String;
    ...
    .line 1704
    .restart local v6    # "rp":Landroid/app/enterprise/RestrictionPolicy;
    :cond_6
    const-string/jumbo v9, "MountService"
    ...
    .line 1706
    .local v7, "toastintent":Landroid/content/Intent;
    iget-object v9, p0, Lcom/android/server/MountService;->mContext:Landroid/content/Context;
    ...
    .line 1709
    .end local v7    # "toastintent":Landroid/content/Intent;
    :cond_7
    const-string/jumbo v9, "MountService"
    ...
    .line 1717
    .end local v3    # "isSdCard":Z
    :cond_9
    const/4 v4, 0x0

    .local v4, "isUsbHost":Z
    goto :goto_1

    .line 1724
    .end local v4    # "isUsbHost":Z
    :cond_a
    if-eqz v3, :cond_b
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 4792
    .local v9, "mStorageVolumes":[Landroid/os/storage/StorageVolume;
    ...
    .line 4798
    .local v16, "svol":Landroid/os/storage/StorageVolume;
    ...
    .line 4801
    .end local v16    # "svol":Landroid/os/storage/StorageVolume;
    :cond_0
    ...
    .line 4829
    .local v11, "note":Landroid/os/storage/VolumeRecord;
    ...
    .line 4831
    .end local v11    # "note":Landroid/os/storage/VolumeRecord;
    :cond_4
    invoke-virtual {v15}, Lcom/android/internal/util/IndentingPrintWriter;->decreaseIndent()V
    ...
    .local v13, "obbState$iterator":Ljava/util/Iterator;
    :goto_6
    ...
    .end local v13    # "obbState$iterator":Ljava/util/Iterator;
    ...
    .restart local v13    # "obbState$iterator":Ljava/util/Iterator;
...
.method public encryptExternalStorage(Z)I
    ...
    .line 3339
    .local v14, "mStorageVolumes":[Landroid/os/storage/StorageVolume;
    const/16 v18, 0x0

    .line 3340
    .local v18, "vId":Ljava/lang/String;
    const/4 v13, 0x0
    ...
    .end local v18    # "vId":Ljava/lang/String;
    :cond_1
    move-object/from16 v0, p0
    ...
    .line 3356
    .end local v13    # "i":I
    .end local v14    # "mStorageVolumes":[Landroid/os/storage/StorageVolume;
    .end local v16    # "storage":Landroid/os/storage/StorageManager;
    .local v19, "vol":Landroid/os/storage/VolumeInfo;
    :goto_1
    const/4 v12, 0x0

    .line 3357
    .local v12, "ext_flag":I
    ...
    .line 3340
    .end local v12    # "ext_flag":I
    .end local v19    # "vol":Landroid/os/storage/VolumeInfo;
    .restart local v13    # "i":I
    .restart local v14    # "mStorageVolumes":[Landroid/os/storage/StorageVolume;
    .restart local v16    # "storage":Landroid/os/storage/StorageManager;
    .restart local v17    # "svol":Landroid/os/storage/StorageVolume;
    .restart local v18    # "vId":Ljava/lang/String;
    :cond_3
    ...
    .restart local v19    # "vol":Landroid/os/storage/VolumeInfo;
    goto :goto_1
    ...
    .line 3371
    .local v11, "event":Lcom/android/server/NativeDaemonEvent;
    :goto_2
    ...
    .line 3369
    .end local v11    # "event":Lcom/android/server/NativeDaemonEvent;
    :cond_6
    move-object/from16 v0, p0
    ...
    .restart local v11    # "event":Lcom/android/server/NativeDaemonEvent;
    goto :goto_2
...
.method public getVolumeList(ILjava/lang/String;I)[Landroid/os/storage/StorageVolume;
    ...
    .line 3814
    .local v37, "res":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/os/storage/StorageVolume;>;"
    move-object/from16 v0, p0
    ...
    .end local v25    # "i":I
    .end local v27    # "includeInvisible":Z
    .end local v34    # "realState":Z
    .end local v37    # "res":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/os/storage/StorageVolume;>;"
    .end local v39    # "storagePermission":Z
    .end local v40    # "token":J
    .end local v43    # "userKeyUnlocked":Z
    ...
    .restart local v27    # "includeInvisible":Z
    goto :goto_2
    ...
    .restart local v37    # "res":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Landroid/os/storage/StorageVolume;>;"
    .restart local v39    # "storagePermission":Z
    .restart local v43    # "userKeyUnlocked":Z
    .restart local v45    # "vol":Landroid/os/storage/VolumeInfo;
    :pswitch_1
    const/16 v28, 0x0
    ...
    .line 3843
    .local v44, "userVol":Landroid/os/storage/StorageVolume;
    ...
    .line 3829
    .end local v36    # "reportUnmounted":Z
    .end local v44    # "userVol":Landroid/os/storage/StorageVolume;
    ...
    .line 3836
    .end local v28    # "match":Z
    .restart local v36    # "reportUnmounted":Z
    :cond_9
    const/16 v36, 0x1
    ...
    .line 3847
    .restart local v44    # "userVol":Landroid/os/storage/StorageVolume;
    :cond_b
    move-object/from16 v0, v37
    ...
    .restart local v29    # "primary":Z
    .restart local v35    # "removable":Z
    :cond_e
    const/4 v11, 0x1
...
.method public mkdirs(Ljava/lang/String;Ljava/lang/String;)I
    ...
    .line 3779
    .local v4, "iex":Ljava/lang/IllegalArgumentException;
    const/4 v8, -0x1

    return v8

    .line 3783
    .end local v4    # "iex":Ljava/lang/IllegalArgumentException;
...
.method public mount(Ljava/lang/String;)V
    ...
    .line 2113
    .local v3, "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    :try_start_0
    ...
    .line 2116
    .end local v3    # "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    .local v4, "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    :goto_0
    if-nez v4, :cond_e
    ...
    .line 2120
    .end local v4    # "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    .restart local v3    # "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    :goto_1
    :try_start_2
    const-string/jumbo v6, "MountService"
    ...
    .line 2186
    .end local v2    # "preSdHiddenMount":Z
    .end local v3    # "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    :catch_0
    move-exception v0
    ...
    .line 2138
    .end local v0    # "e":Lcom/android/server/NativeDaemonConnectorException;
    .restart local v2    # "preSdHiddenMount":Z
    .restart local v3    # "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    :cond_4
    :try_start_3
    const-string/jumbo v6, "MountService"
    ...
    .end local v2    # "preSdHiddenMount":Z
    .end local v3    # "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    .restart local v4    # "sdPolicies":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    :catch_1
    move-exception v0
...
.method requiredEncPolicyCheck(Ljava/lang/String;)Z
    ...
    .line 4522
    .local v1, "eas_policy":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
    iget-object v4, p0, Lcom/android/server/MountService;->mContext:Landroid/content/Context;
    ...
    .line 4526
    .end local v1    # "eas_policy":Lcom/samsung/android/security/SemSdCardEncryptionPolicy;
