...
.method public run()V
    ...
    .line 305
    .local v24, "requestLine":Ljava/lang/String;
    :try_start_0
    ...
    .line 315
    .local v26, "splitLine":[Ljava/lang/String;
    ...
    .line 311
    .end local v26    # "splitLine":[Ljava/lang/String;
    .local v24, "requestLine":Ljava/lang/String;
    :cond_1
    move-object/from16 v0, p0
    ...
    .line 320
    .restart local v26    # "splitLine":[Ljava/lang/String;
    :cond_2
    const/4 v3, 0x0
    ...
    .line 322
    .local v28, "urlString":Ljava/lang/String;
    const/4 v3, 0x2
    ...
    .line 330
    .local v14, "hostPortSplit":[Ljava/lang/String;
    const/4 v3, 0x0
    ...
    .end local v14    # "hostPortSplit":[Ljava/lang/String;
    :goto_2
    move-object/from16 v0, p0
    ...
    .line 370
    .end local v25    # "server":Ljava/net/Socket;
    .local v5, "server":Ljava/net/Socket;
    :try_start_2
    move-object/from16 v0, p0
    ...
    .line 374
    .local v23, "proxyString":Ljava/lang/String;
    ...
    .line 380
    .local v22, "proxyAuthenticator":Lcom/android/server/enterprise/proxy/auth/ProxyAuthenticator;
    if-eqz v22, :cond_3
    ...
    .end local v22    # "proxyAuthenticator":Lcom/android/server/enterprise/proxy/auth/ProxyAuthenticator;
    .end local v23    # "proxyString":Ljava/lang/String;
    :goto_4
    if-eqz v5, :cond_d
    ...
    .end local v8    # "httpVersion":Ljava/lang/String;
    ...
    .end local v21    # "proxy$iterator":Ljava/util/Iterator;
    .end local v24    # "requestLine":Ljava/lang/String;
    .end local v26    # "splitLine":[Ljava/lang/String;
    .end local v28    # "urlString":Ljava/lang/String;
    :cond_6
    :goto_7
    :try_start_4
    move-object/from16 v0, p0
    ...
    .line 336
    .restart local v6    # "requestType":Ljava/lang/String;
    .restart local v7    # "url":Ljava/net/URI;
    .restart local v8    # "httpVersion":Ljava/lang/String;
    .restart local v13    # "host":Ljava/lang/String;
    .restart local v14    # "hostPortSplit":[Ljava/lang/String;
    .restart local v24    # "requestLine":Ljava/lang/String;
    .restart local v26    # "splitLine":[Ljava/lang/String;
    .restart local v28    # "urlString":Ljava/lang/String;
    :cond_7
    const/4 v3, 0x1
    ...
    .end local v27    # "url":Ljava/net/URI;
    .local v7, "url":Ljava/net/URI;
    goto/16 :goto_2
    ...
    .restart local v21    # "proxy$iterator":Ljava/util/Iterator;
    .restart local v22    # "proxyAuthenticator":Lcom/android/server/enterprise/proxy/auth/ProxyAuthenticator;
    .restart local v23    # "proxyString":Ljava/lang/String;
    :cond_a
    :try_start_a
    ...
    .end local v22    # "proxyAuthenticator":Lcom/android/server/enterprise/proxy/auth/ProxyAuthenticator;
    .end local v23    # "proxyString":Ljava/lang/String;
    .restart local v25    # "server":Ljava/net/Socket;
    :cond_b
    :try_start_b
    const-string/jumbo v3, "EnterpriseProxyServer"
    ...
    .end local v20    # "proxy":Ljava/net/Proxy;
    .end local v21    # "proxy$iterator":Ljava/util/Iterator;
    .restart local v27    # "url":Ljava/net/URI;
    :catch_6
    move-exception v12

    .restart local v12    # "e":Ljava/net/URISyntaxException;
    move-object/from16 v7, v27
