...
.method public declared-synchronized checkPolicy(Ljava/lang/String;)I
    ...
    .restart local v5    # "pd":Lcom/android/server/enterprise/otp/engine/handler/db/PolicyData;
    :cond_4
    monitor-exit p0
...
.method public declared-synchronized getOtpTokenList(Ljava/lang/String;Ljava/lang/String;I)Ljava/util/List;
    ...
    .line 288
    .local v8, "tokenList":Ljava/util/List;, "Ljava/util/List<Lcom/samsung/android/knox/otp/OTPToken;>;"
    ...
    .end local v8    # "tokenList":Ljava/util/List;, "Ljava/util/List<Lcom/samsung/android/knox/otp/OTPToken;>;"
    :catchall_0
    move-exception v9
    ...
    .restart local v8    # "tokenList":Ljava/util/List;, "Ljava/util/List<Lcom/samsung/android/knox/otp/OTPToken;>;"
    :cond_2
    monitor-exit p0
...
.method public declared-synchronized isAccessToTokenAllowed(Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)I
    ...
    .line 491
    .local v2, "pd":Lcom/android/server/enterprise/otp/engine/handler/db/ProvisionData;
    if-eqz v2, :cond_3
    ...
    .line 502
    .local v5, "signList":[Ljava/lang/String;
    const/4 v1, 0x0
    ...
    .end local v5    # "signList":[Ljava/lang/String;
    :catch_0
    move-exception v0
    ...
    .end local v2    # "pd":Lcom/android/server/enterprise/otp/engine/handler/db/ProvisionData;
    :catchall_0
    move-exception v6
...
.method public declared-synchronized updateTokenWhitelist(Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    .line 699
    .local v8, "pd":Lcom/android/server/enterprise/otp/engine/handler/db/ProvisionData;
    if-eqz v8, :cond_a
    ...
    .line 702
    .local v9, "removeList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    ...
    .line 725
    .local p2, "bundle":Landroid/os/Bundle;
    const/16 v14, 0x401
    ...
    .end local v8    # "pd":Lcom/android/server/enterprise/otp/engine/handler/db/ProvisionData;
    .end local v9    # "removeList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
    .end local v10    # "ret":I
    ...
    .restart local v8    # "pd":Lcom/android/server/enterprise/otp/engine/handler/db/ProvisionData;
    .restart local v9    # "removeList":Ljava/util/List;, "Ljava/util/List<Ljava/lang/String;>;"
