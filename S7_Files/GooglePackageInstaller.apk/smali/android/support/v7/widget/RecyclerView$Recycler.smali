...
# direct methods
.method static synthetic -get0(Landroid/support/v7/widget/RecyclerView$Recycler;)Ljava/util/ArrayList;
    .locals 1
...
.method private attachAccessibilityDelegate(Landroid/view/View;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->-get1(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerViewAccessibilityDelegate;
...
.method dispatchViewRecycled(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->-get10(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$RecyclerListener;
...
.method getChangedScrapViewForPosition(I)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {v6}, Landroid/support/v7/widget/RecyclerView;->-get2(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$Adapter;
...
.method getScrapViewForPosition(IIZ)Landroid/support/v7/widget/RecyclerView$ViewHolder;
    ...
    invoke-static {v7}, Landroid/support/v7/widget/RecyclerView$State;->-get1(Landroid/support/v7/widget/RecyclerView$State;)Z
...
.method getViewForPosition(IZ)Landroid/view/View;
    ...
    invoke-static {v10}, Landroid/support/v7/widget/RecyclerView;->-get2(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$Adapter;
    ...
    invoke-static {v10}, Landroid/support/v7/widget/RecyclerView$State;->-get4(Landroid/support/v7/widget/RecyclerView$State;)Z
    ...
    invoke-static {v10, v3, v4}, Landroid/support/v7/widget/RecyclerView;->-wrap16(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
...
.method markKnownViewsInvalid()V
    ...
    invoke-static {v3}, Landroid/support/v7/widget/RecyclerView;->-get2(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$Adapter;
...
.method recycleViewHolderInternal(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v6, p1}, Landroid/support/v7/widget/RecyclerView$Adapter;->onFailedToRecycleView(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    .line 5227
    iput-object v7, p1, Landroid/support/v7/widget/RecyclerView$ViewHolder;->mOwnerRecyclerView:Landroid/support/v7/widget/RecyclerView;
...
.method scrapView(Landroid/view/View;)V
    ...
    invoke-static {v1, v0}, Landroid/support/v7/widget/RecyclerView;->-wrap1(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
...
.method validateViewHolderForOffsetPosition(Landroid/support/v7/widget/RecyclerView$ViewHolder;)Z
    ...
    invoke-static {v4}, Landroid/support/v7/widget/RecyclerView;->-get2(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$Adapter;
