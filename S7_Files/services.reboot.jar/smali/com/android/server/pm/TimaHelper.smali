...
.method private constructor <init>()V
    ...
    const-string/jumbo v3, "TimaHelper created"
...
.method public checkEntry(ILjava/lang/String;)Z
    ...
    .line 170
    .local v4, "te":Lcom/android/server/pm/TimaException;
    const/4 v5, 0x0

    return v5

    .line 160
    .end local v4    # "te":Lcom/android/server/pm/TimaException;
...
.method public deleteEntry(ILjava/lang/String;)V
    ...
    .prologue
    .line 252
    sget-boolean v4, Lcom/android/server/pm/TimaHelper;->timaVersion20:Z
    ...
    const-string/jumbo v6, "deleteEntry("
    ...
    .line 254
    const-string/jumbo v6, "TimaHelper doesn\'t support Tima 2.0! error"
...
.method public getEntry(ILjava/lang/String;)[B
    ...
    .line 215
    const-string/jumbo v8, "TimaHelper doesn\'t support Tima 2.0! error"
...
.method public getTimaStatus()I
    ...
    const-string/jumbo v8, "getTimaStatus() - Tima Status : "
    ...
    invoke-static {v6, v7}, Lcom/sec/sdp/internal/SDPLog;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v6, v7}, Landroid/service/tima/ITimaService;->FipsKeyStore3_init(Z)I
    ...
    const-string/jumbo v8, "getTimaStatus() - Unknown Tima Version... "
    ...
    const-string/jumbo v7, "getTimaStatus() - Failed to access to tima service..."
    ...
    const-string/jumbo v7, "getTimaStatus() - Failed due to unexpected error..."
...
.method public migrateToFips30(I)Z
    ...
    .line 319
    .local v9, "oldKeystore":Ljava/security/KeyStore;
    const/4 v8, 0x0

    .line 320
    .local v8, "newKeystore":Ljava/security/KeyStore;
    const/4 v10, 0x0
    ...
    .end local v7    # "keyEntry":Ljava/security/KeyStore$SecretKeyEntry;
    .end local v8    # "newKeystore":Ljava/security/KeyStore;
    .end local v9    # "oldKeystore":Ljava/security/KeyStore;
    :catch_0
    move-exception v3
    ...
    .restart local v8    # "newKeystore":Ljava/security/KeyStore;
    .restart local v9    # "oldKeystore":Ljava/security/KeyStore;
    :cond_2
    :try_start_1
    const-string/jumbo v13, "TimaHelper"
...
.method public setEntry(ILjava/lang/String;[B)Z
    ...
    .line 178
    .local v3, "result":Z
    sget-boolean v7, Lcom/android/server/pm/TimaHelper;->timaVersion20:Z
    ...
    .line 180
    const-string/jumbo v9, "TimaHelper doesn\'t support Tima 2.0! error"
    ...
    .line 205
    .local v6, "te":Lcom/android/server/pm/TimaException;
    const/4 v7, 0x0

    return v7

    .line 195
    .end local v6    # "te":Lcom/android/server/pm/TimaException;
    :catch_2
    move-exception v1
