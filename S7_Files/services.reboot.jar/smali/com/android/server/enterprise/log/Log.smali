...
.method public static d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .local v1, "ilog$iterator":Ljava/util/Iterator;
    :goto_0
    ...
    check-cast v0, Lcom/android/server/enterprise/log/Logger;

    .line 149
    .local v0, "ilog":Lcom/android/server/enterprise/log/Logger;
    const/4 v2, 0x3

    invoke-virtual {v0, v2, p0, p1}, Lcom/android/server/enterprise/log/Logger;->log(ILjava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 147
    .end local v0    # "ilog":Lcom/android/server/enterprise/log/Logger;
    :cond_0
    return-void
.end method
...
.method public static d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {v0, v3, p0, v2}, Lcom/android/server/enterprise/log/Logger;->log(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static declared-synchronized getLogger(Ljava/lang/String;)Lcom/android/server/enterprise/log/Logger;
    ...
    .local v1, "logger$iterator":Ljava/util/Iterator;
    :cond_1
    invoke-interface {v1}, Ljava/util/Iterator;->hasNext()Z
    ...
    iget-object v2, v0, Lcom/android/server/enterprise/log/Logger;->loggerName:Ljava/lang/String;
    ...
    .end local v0    # "logger":Lcom/android/server/enterprise/log/Logger;
    :cond_2
    monitor-exit v3
    ...
    .end local v1    # "logger$iterator":Ljava/util/Iterator;
    :catchall_0
    move-exception v2
