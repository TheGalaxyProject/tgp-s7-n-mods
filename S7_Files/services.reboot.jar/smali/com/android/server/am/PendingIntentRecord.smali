...
.method sendInner(ILandroid/content/Intent;Ljava/lang/String;Landroid/content/IIntentReceiver;Ljava/lang/String;Landroid/os/IBinder;Ljava/lang/String;IIILandroid/os/Bundle;Landroid/app/IActivityContainer;Landroid/app/IApplicationThread;)I
    ...
    .end local v34    # "immutable":Z
    .end local v36    # "origId":J
    .end local v38    # "res":I
    .end local v39    # "sendFinish":Z
    :cond_a
    :try_start_4
    new-instance v13, Landroid/content/Intent;
    ...
    .restart local v39    # "sendFinish":Z
    goto :goto_5
    ...
    .line 321
    .local v35, "opts":Landroid/os/Bundle;
    move-object/from16 v0, v35
    ...
    .line 339
    .end local v35    # "opts":Landroid/os/Bundle;
    :cond_12
    :try_start_8
    move-object/from16 v0, p0
    ...
    .line 365
    .restart local v33    # "e":Ljava/lang/RuntimeException;
    :try_start_b
    sget-object v2, Lcom/android/server/am/PendingIntentRecord;->TAG:Ljava/lang/String;
    ...
    .line 375
    .local v32, "e":Landroid/os/TransactionTooLargeException;
    const/16 v38, -0x6
    ...
    .end local v9    # "userId":I
    .end local v13    # "finalIntent":Landroid/content/Intent;
    .end local v32    # "e":Landroid/os/TransactionTooLargeException;
    .end local v34    # "immutable":Z
    .end local v36    # "origId":J
    .end local v38    # "res":I
    .end local v39    # "sendFinish":Z
