...
.method constructor <init>(Lcom/android/server/input/InputManagerService;[Ljava/lang/String;Ljava/util/ArrayList;Landroid/hardware/input/InputDeviceIdentifier;Ljava/util/ArrayList;)V
    ...
    iput-object p2, p0, Lcom/android/server/input/InputManagerService$9;->val$enabledLayoutDescriptors:[Ljava/lang/String;

    iput-object p3, p0, Lcom/android/server/input/InputManagerService$9;->val$enabledLayouts:Ljava/util/ArrayList;

    iput-object p4, p0, Lcom/android/server/input/InputManagerService$9;->val$identifier:Landroid/hardware/input/InputDeviceIdentifier;

    iput-object p5, p0, Lcom/android/server/input/InputManagerService$9;->val$potentialLayouts:Ljava/util/ArrayList;
...
.method public visitKeyboardLayout(Landroid/content/res/Resources;ILandroid/hardware/input/KeyboardLayout;)V
    ...
    .line 1719
    iget-object v2, p0, Lcom/android/server/input/InputManagerService$9;->val$enabledLayoutDescriptors:[Ljava/lang/String;
    ...
    .line 1721
    iget-object v1, p0, Lcom/android/server/input/InputManagerService$9;->val$enabledLayouts:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Lcom/android/server/input/InputManagerService$9;->val$identifier:Landroid/hardware/input/InputDeviceIdentifier;
    ...
    .line 1731
    iget-boolean v1, p0, Lcom/android/server/input/InputManagerService$9;->mHasSeenDeviceSpecificLayout:Z
    ...
    iput-boolean v1, p0, Lcom/android/server/input/InputManagerService$9;->mHasSeenDeviceSpecificLayout:Z

    .line 1733
    iget-object v1, p0, Lcom/android/server/input/InputManagerService$9;->val$potentialLayouts:Ljava/util/ArrayList;
