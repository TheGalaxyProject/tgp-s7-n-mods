...
.method private broadcastChange(Landroid/net/Uri;)V
    ...
    .line 413
    .local v2, "tempList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;>;"
    if-eqz v2, :cond_1
    ...
    .line 417
    .local v1, "listener":Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;
    if-eqz v1, :cond_0
    ...
    .line 406
    .end local v0    # "i":I
    .end local v1    # "listener":Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;
    :cond_1
    return-void
.end method
...
.method public is24HourModeEnabled()Z
    ...
    .line 516
    .local v0, "clockFormat":Ljava/lang/String;
    if-eqz v0, :cond_0
...
.method public varargs registerCallback(Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;[Landroid/net/Uri;)V
    .locals 8
    .param p1, "listener"    # Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;
    ...
    .line 343
    .local v2, "sizeOfUris":I
    new-instance v3, Ljava/lang/ref/WeakReference;

    invoke-direct {v3, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    .line 344
    .local v3, "weakReference":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;"
    const/4 v1, 0x0
    ...
    .line 346
    .local v0, "arrayList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;>;"
    if-eqz v0, :cond_0
    ...
    .line 340
    .end local v0    # "arrayList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;>;"
    .end local v1    # "i":I
    .end local v2    # "sizeOfUris":I
    .end local v3    # "weakReference":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;"
    :catchall_0
    move-exception v4
    ...
    .restart local v2    # "sizeOfUris":I
    .restart local v3    # "weakReference":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;"
    :cond_2
    monitor-exit p0
...
.method public setHomeTimeZone(Ljava/lang/String;)V
    .locals 2
    .param p1, "homeTimeZone"    # Ljava/lang/String;
...
.method public unregisterCallback(Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;)V
    ...
    .line 380
    .local v4, "tempList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;>;"
    if-eqz v4, :cond_2
    ...
    .line 384
    .local v5, "weakReference":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;"
    ...
    .line 388
    .end local v5    # "weakReference":Ljava/lang/ref/WeakReference;, "Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;"
    :cond_1
    ...
    .line 378
    .end local v1    # "jIdx":I
    .end local v3    # "sizeOfTempList":I
    :cond_2
    add-int/lit8 v0, v0, -0x1

    goto :goto_0

    .end local v4    # "tempList":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Ljava/lang/ref/WeakReference<Lcom/android/keyguard/util/SettingsHelper$OnChangedCallback;>;>;"
    :cond_3
    monitor-exit p0
