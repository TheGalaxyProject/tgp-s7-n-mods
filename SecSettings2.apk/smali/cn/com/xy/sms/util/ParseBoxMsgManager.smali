.class public Lcn/com/xy/sms/util/ParseBoxMsgManager;
...
.method private static a(Ljava/util/Map;Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    :goto_3
    invoke-static {p0}, Lcn/com/xy/sms/util/ParseBoxMsgManager;->b(Ljava/util/Map;)Lorg/json/JSONObject;
    :try_end_0
    ...
    const-string/jumbo v3, "parseMsgToBubbleResult: "
...
.method public static parseMsgForBox(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)Lorg/json/JSONObject;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0}, Lcn/com/xy/sms/sdk/dex/DexUtil;->handerBoxValueMap(Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    :cond_7
    :goto_2
    invoke-static {v0, p4}, Lcn/com/xy/sms/util/ParseBoxMsgManager;->a(Ljava/util/Map;Ljava/util/Map;)Lorg/json/JSONObject;
    ...
    const-string/jumbo v2, "boxJsObj"
